<template>
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-button class="filter-item" size="mini" type="success" icon="el-icon-search" @click="searchbirth" width="200px">一键查询今日生日用户</el-button>
      <el-button class="filter-item" size="mini" type="success" icon="el-icon-search" @click="toQuery">搜索</el-button>
      <el-button class="filter-item" size="mini" type="success" icon="el-icon-add" @click="addForm">新增</el-button>
      <!-- 新增 -->
      <el-button
        type="danger"
        class="filter-item"
    ...
    <addform ref="addform" :isAddForm="isAddForm" />
    <!--表格渲染-->
    <el-table v-loading="loading" :data="data" size="small"  style="width: 100%;">
      <el-table-column prop="uid" label="用户id" sortable :sort-orders="['descending','ascending']" />
      ...
      <el-table-column :show-overflow-tooltip="true" prop="birthday" width="180" align="center" label="生日">
        <template slot-scope="scope">
          <span>{{ formatTime(scope.row.birthday,"{y}-{m}-{d} {h}:{i}:{s}") }}</span>
        </template>
      </el-table-column>
...
import { del, onStatus,getBirthUser } from '@/api/yxUser'
...
export default {
  components: { eForm, pForm ,addform},
  mixins: [initData],
  data() {
    return {
      delLoading: false,
