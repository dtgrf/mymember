...
public class MemberController {
    ...
    @GetMapping(value = "/yxUser/getAllList")
    @PreAuthorize("hasAnyRole('admin','YXUSER_ALL','YXUSER_SELECT')")
    public ResponseEntity getAllYxUsers() {
        return new ResponseEntity(yxUserService.queryAll(new YxUserQueryCriteria()), HttpStatus.OK);
    }
    @Log("查询所有用户")
    @ApiOperation(value = "查询所有用户")
    @GetMapping(value = "/yxUser/getBirthList")
    @PreAuthorize("hasAnyRole('admin','YXUSER_ALL','YXUSER_SELECT')")
    public ResponseEntity getAllBirthYxUsers() {
        return new ResponseEntity(yxUserService.queryBirthAll(), HttpStatus.OK);
    }
