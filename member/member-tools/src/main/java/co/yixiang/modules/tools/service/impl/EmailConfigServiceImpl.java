...
//    @CachePut(key = "'1'")
    ...
    public void update(EmailConfig emailConfig, EmailConfig old) {
        ...
        LambdaUpdateWrapper<EmailConfig> lambdaUpdateWrapper = new LambdaUpdateWrapper<>();
        lambdaUpdateWrapper.eq(EmailConfig::getId, emailConfig.getId())
                .set(EmailConfig::getHost, emailConfig.getHost())
                .set(EmailConfig::getPass, emailConfig.getPass())
                .set(EmailConfig::getPort, emailConfig.getPort())
                .set(EmailConfig::getFromUser, emailConfig.getFromUser())
                .set(EmailConfig::getUser, emailConfig.getUser());
